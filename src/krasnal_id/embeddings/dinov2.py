"""DINOv2 backbone adapter placeholder."""
...
class DinoV2Backbone:
    """Lazy DINOv2 adapter that will use the optional ML dependencies."""
    ...
    def get_embedding(self, image: Image.Image) -> npt.NDArray[np.float32]:
        """Extract one normalized DINOv2 embedding."""
        raise NotImplementedError("DINOv2 extraction is scheduled for v0.1")
